    ...
    <div className="flex flex-col gap-10 items-center justify-center p-4 h-full w-full">
      ...
      <div className="flex flex-col items-start w-full max-w-96">
        ...
        <input
          ...
          className="w-full px-3 py-1.5 rounded-xl outline-none appearance-none bg-sage-400/60 caret-sage-600 border border-transparent focus:border-sage-600 text-center mb-4"
